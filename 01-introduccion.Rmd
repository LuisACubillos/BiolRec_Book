...
```{r desembarques-fig, message=FALSE, echo=FALSE, fig.cap="Desembarque total de peces en Chile, 2015-2025. Fuente: SERNAPESCA 2025", warning=FALSE}
anos   <- 2015:2025
...
```{r estados-table, echo=FALSE,warning=FALSE}
...
```{r estado-2025-fig, fig.cap="Estado de las pesquerías chilenas con PBR definido, 2025. Fuente: SUBPESCA 2025",echo=FALSE,warning=FALSE}
df_pbr <- data.frame(
...
```{r glosario-table,echo=FALSE,warning=FALSE}
glosario <- data.frame(
  ...
  Definición = c(
    ...
    "Tasa instantánea de mortalidad anual por causa de la pesca.",
    ...
    "Comité Científico Técnico Pesquero: órgano asesor que define el estado de situación, los PBR, y recomienda el rango de captura biológicamente aceptable.",
    ...
    "Individuos jóvenes que se incorporan al stock explotable.",
