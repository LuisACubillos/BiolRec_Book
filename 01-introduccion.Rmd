...
```{r desembarques-fig, echo=FALSE, fig.cap="Desembarque total de peces en Chile, 2015-2025. Fuente: SERNAPESCA 2025"}
anos   <- 2015:2025
...
```{r estado-2025-fig, fig.cap="Estado de las pesquerías chilenas con PBR definido, 2025. Fuente: SUBPESCA 2025",echo=FALSE}
df_pbr <- data.frame(
